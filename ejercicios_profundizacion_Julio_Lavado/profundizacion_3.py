...
for temp in temperaturas:
  suma_total += temp
  cantidad_temperatura += 1
   
promedio = suma_total / cantidad_temperatura

print(f'La suma total de temperaturas es : {round(suma_total,2)}')
print(f'El promedio de temperatura es : {round(promedio,2)}')
print(f'La temperatura maxima es : {max(temperaturas)}')
print(f'La temperatura minima es : {min(temperaturas)}')