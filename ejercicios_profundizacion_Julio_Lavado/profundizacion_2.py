...
for nota in notas:
    if nota >= 0:
        ...
        print(f'Alumnos ausente {nota}')

promedio = suma_notas/cantidad_de_presentes

print(f'El total de ausentes es : {len(notas)-cantidad_de_presentes}')
print(f'El promedio de notas es : {round(promedio,2)}')
